				...
				<div class="row">
					...
					<div class="col-md-8">
						...
						<ul class="article-breadcrumb">
							...
							<li>Apple HomeKit - умный дом, управляемый SIRI
</li>
						</ul>
						<!-- /breadcrumb -->
						...
						<article class="article article-post">
							...
							<div class="article-body">
								...
								<h1 class="article-title">Apple HomeKit - умный дом, управляемый SIRI</h1>
								<ul class="article-meta">
									<li><i class="fa fa-clock-o"></i>  Май 17, 2018</li>
									<li><i class="fa fa-comments"></i> 47</li>
								</ul>
								<p>На выставке высоких технологий CES 2015 компания Apple представила свою систему Smart Home (Умный дом) с поддержкой голосового управления на SIRI</p>
								<p>Все приборы и устройства, работающие в системе "Умный дом" будут иметь поддержку SIRI, и управлять ими возможно с любого мобильного или не очень устройства, по средством беспроводных технологий таких, как Bluetoth и др. Переключатели, выключатели и всякого рода датчики для системы SmartHome будут по цене около 50-ти долларов, когда сама система управления всеми устройствами обойдется обывателю в 200-300 долларов в зависимости от модификаций</p> 
								<p>Управлять голосов в умном доме можно будет практически всем, будь то телевизор или уровень яркости освещения где-нибудь на кухне. Мало того компания Apple постоянно модифицирует свою систему и список команд постоянно пополняется, что делает умный дом, более "дружелюбным" к общению со своим владельцем. Вот только некоторые команды, поддерживаемые в SIRI</p> 
								<p>- Включить/выключить свет <br>- сделать температуру в 20 градусов  <br>- установить яркость освещения на кухне в 65 процентов <br> -  выключить кофе машину</p> 
