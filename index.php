...
<html lang="en">
    ...
    <div class="panel1">
						<ul>
							...
							<li><a href="#login_form" id="login_pop"><i class="fa fa-sign-in"></i><b>ВХОД</b></a></li>
                            <li><a href="#join_form" id="join_pop"></i><b>ЗАРЕГИСТРИРОВАТЬСЯ</b></a></li>
						</ul>
					</div>
		...
		<div id="owl-carousel-1" class="owl-carousel owl-theme center-owl-nav">
			...
			<article class="article thumb-article">
				...
				<div class="article-body">
					...
					<h2 class="article-title"><a href="post.php">Китай объявил о создании первого в мире эксафлопсного суперкомпьютера</a></h2>
			...
			<article class="article thumb-article">
				...
				<div class="article-body">
					...
					<h2 class="article-title"><a href="ost.php">Суперкомпьютер смоделировал работу всей сердечно-сосудистой системы человека</a></h2>
					<ul class="article-meta">
						<li><i class="fa fa-clock-o"></i> Май 17, 2018</li>
			...
			<article class="article thumb-article">
				...
				<div class="article-body">
					...
					<h2 class="article-title"><a href="ho.php">Apple HomeKit - умный дом, управляемый SIRI</a></h2>
					<ul class="article-meta">
						<li><i class="fa fa-clock-o"></i> Май 17, 2018</li>
